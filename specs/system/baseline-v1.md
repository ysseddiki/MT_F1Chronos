...
| Route | Rôle |
|---|---|
| `/t/all` | Classement + Expérience agrégés (toutes orgs visibles) |
...
| `/admin` | CRUD tenants/sims/users, réglages (accès public + barème points) |
